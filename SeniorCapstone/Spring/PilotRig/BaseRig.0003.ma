...
//Name: BaseRig.0003.ma
//Last modified: Fri, Jan 08, 2016 01:54:44 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.7724981596296638 13.210667880161543 1.2873986316024315 ;
	setAttr ".r" -type "double3" -63.338352729696403 16.999999999995076 1.6629399057314596e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "023E8188-412E-56E7-B7C3-3D94DA035E30";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 2.4355033576295986;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.1690048540252684 100.1 -0.55866917773628744 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.1681995784490171 9.9349494365393358 100.28289546259649 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "410C269D-4FDE-9ED7-52D5-0091BFF41BB9";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 1.4882183747213642;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 7.4759076621816121 -0.75831752399877039 ;
...
createNode joint -n "jnt_clavicleL_bnd";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 0 0 27.728257422319246 ;
	setAttr ".radi" 0.5;
createNode joint -n "jnt_shoulderL_bnd" -p "jnt_clavicleL_bnd";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" -0.023499300744428558 1.0340254200373618 -29.030210094898056 ;
...
createNode joint -n "jnt_elbowL_bnd" -p "jnt_shoulderL_bnd";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 0 -2.4705769929490655 1.3017406191394323 ;
	setAttr ".radi" 0.5;
...
createNode joint -n "jnt_thighL_bnd";
	rename -uid "B027CA3C-48E7-1185-BD1C-9EB3BF6B7005";
	setAttr ".t" -type "double3" 0.55268682651058398 5.9765737199896982 -0.65303234945721966 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 90 -4.176195766271924 -90 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EBA35BBA-46CB-1568-E98A-57B89F7FA8EB";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "C53E4654-41DF-4B60-DB1B-0DA7C5E7F759";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A2A1A4A7-42A5-4C2B-39B2-F89CA67637EF";
