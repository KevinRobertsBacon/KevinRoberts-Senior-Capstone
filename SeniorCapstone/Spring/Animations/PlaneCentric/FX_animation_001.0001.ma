...
//Last modified: Thu, Mar 17, 2016 01:37:30 PM
//Codeset: 1252
...
createNode transform -n "MainCamera";
	...
	setAttr ".t" -type "double3" 85.904213350066001 23.134010705974688 104.04577633760702 ;
	setAttr -av ".tx";
	setAttr -av ".ty";
	setAttr -av ".tz";
	setAttr ".r" -type "double3" -6.000000000000008 32.4 0 ;
	setAttr -av ".rx";
	setAttr -av ".ry";
	setAttr -av ".rz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BCC8B875-481A-0E6D-5F87-52A2C4DBAB43";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "DC3B64C4-41BF-82A3-9F1D-C688E0D95000";
createNode displayLayer -n "defaultLayer";
	rename -uid "65D8BB10-4923-E2C6-5C4E-7498BED03060";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0E614D1B-4BF6-3324-A7B7-6389255955C9";
...
createNode reference -n "FighterModelMaya_RIGVERSION_0065RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|fighter_Main_Ctrl" "translate" " -type \"double3\" 0 9.4808115732203575 0"
		
		2 "|fighter_Main_Ctrl" "translateY" " -av"
		2 "|fighter_Main_Ctrl" "translateX" " -av"
		2 "|fighter_Main_Ctrl" "translateZ" " -av"
		2 "|fighter_Main_Ctrl" "rotate" " -type \"double3\" 0 0 0"
		...
		" -av -k 1 10"
		2 "|fighter_Main_Ctrl|Text_FrontxGearxControl_1" "gearControl" " -av -k 1 10"
		...
		2 "|fighter_Main_Ctrl|Text_MachinegunxControl_1" "fireMachinegun" " -av -k 1 0"
		
		2 "|fighter_Main_Ctrl|Text_BackxGearxControl_1" "leftGearHatch" " -av -k 1 10"
		
		2 "|fighter_Main_Ctrl|Text_BackxGearxControl_1" "rightGearHatch" " -av -k 1 10"
		
		2 "|fighter_Main_Ctrl|Text_BackxGearxControl_1" "leftGear" " -av -k 1 10"
		
		2 "|fighter_Main_Ctrl|Text_BackxGearxControl_1" "rightGear" " -av -k 1 10"
		
		2 "|fighter_Main_Ctrl|Text_SpinxEnginexControl_1" "engineSpinning" " -av -k 1 -0.099999999999997868"
		...
		2 "|fighter_Main_Ctrl|Text_TopxModsxControl_1" "mainWeaponFire" " -av -k 1 0"
...
createNode animCurveTA -n "fighter_Main_Ctrl_rotateX";
	...
	setAttr -s 15 ".ktv[0:14]"  1 0 3 0 14 -5.2504859498927212 35 12.128866042164201
		 ...
		 399 -5.6166393292615444 431 -8.6162508264973372 451 -8.6162508264973372;
...
createNode animCurveTA -n "fighter_Main_Ctrl_rotateY";
	...
	setAttr -s 15 ".ktv[0:14]"  1 0 3 0 14 0 35 0 50 0 69 0 91 0 111 0 120 0
		 242 -18.997634295021005 321 -43.931020971844632 364 -153.55043291830575 399 -174.64506957620245
		 431 -174.64506957620245 451 -174.64506957620245;
...
createNode animCurveTA -n "MainCamera_rotateX";
	...
	setAttr -s 7 ".ktv[0:6]"  1 -5.4000000000000021 25 1.8 138 3.5999999999999939
		 201 3.5999999999999988 288 4.7999999999999883 348 6.599999999999981 421 -6.0000000000000044;
...
select -ne :ikSystem;
	setAttr -s 2 ".sol";
connectAttr "fighter_Main_Ctrl_translateY.o" "FighterModelMaya_RIGVERSION_0065RN.phl[1]"
		;
connectAttr "fighter_Main_Ctrl_translateX.o" "FighterModelMaya_RIGVERSION_0065RN.phl[2]"
		;
connectAttr "fighter_Main_Ctrl_translateZ.o" "FighterModelMaya_RIGVERSION_0065RN.phl[3]"
		;
connectAttr "fighter_Main_Ctrl_visibility.o" "FighterModelMaya_RIGVERSION_0065RN.phl[4]"
		;
connectAttr "fighter_Main_Ctrl_rotateX.o" "FighterModelMaya_RIGVERSION_0065RN.phl[5]"
		;
connectAttr "fighter_Main_Ctrl_rotateY.o" "FighterModelMaya_RIGVERSION_0065RN.phl[6]"
		;
connectAttr "fighter_Main_Ctrl_rotateZ.o" "FighterModelMaya_RIGVERSION_0065RN.phl[7]"
		;
