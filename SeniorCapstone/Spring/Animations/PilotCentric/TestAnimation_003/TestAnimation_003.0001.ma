...
//Name: TestAnimation_003.0001.ma
//Last modified: Tue, Mar 15, 2016 12:06:39 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 29.257387269388687 61.311618875163646 105.4377457023124 ;
	setAttr ".r" -type "double3" -19.538352729598213 378.99999999994759 4.2047755109497984e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "953F2F1E-4814-8E8E-2185-1884BA3E931A";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 171.33728866592276;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 72.579953165570643 7.4837398919307727 -33.605371864723253 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8464F10C-4D59-5762-52FE-10AA844B14DC";
	setAttr -s 15 ".lnk";
	setAttr -s 15 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "798E6669-4595-6AC0-42D8-2290345265F5";
createNode displayLayer -n "defaultLayer";
	rename -uid "6AFDADEC-483F-B944-C2A3-6A9341944487";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "32742953-42D0-1767-2F6B-A5A4211F7620";
...
createNode reference -n "BaseRig_0133RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"BaseRig_0133RN" 0
		"BaseRig_0133RN" 2
		2 "|Ctrl_Main_Grp|MainCtrl" "translate" " -type \"double3\" 40.681280915249388 0 -17.969594543682589"
		
		2 "|Ctrl_Main_Grp|MainCtrl" "rotate" " -type \"double3\" 0 -96.143283504363879 0";
...
createNode reference -n "FighterModelMaya_RIGVERSION_0065RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"FighterModelMaya_RIGVERSION_0065RN" 16
...
// End of TestAnimation_003.0001.ma
