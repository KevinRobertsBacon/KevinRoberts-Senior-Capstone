...
//Name: PilotTestAnimation_002.0002.ma
//Last modified: Thu, Mar 10, 2016 12:13:04 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.156639753437652 9.9190299744815249 36.537716290001931 ;
	setAttr ".r" -type "double3" -9.9383527295206164 -349.39999999984906 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "974538BD-47FC-183A-DC61-CA92F829F02E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 35.963793496968144;
...
createNode reference -n "BaseRig_0133RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" 50.936491677409926 -0.59137187567924043 0"
		...
		"rotate" " -type \"double3\" 25.273884222104812 -8.3427594371830303 -6.1780441399491171"
		...
		"rotate" " -type \"double3\" 0 -37.749690515890464 -8.1977789014616675"
		2 "|Ctrl_Main_Grp|MainCtrl|ctrl_grp|center_ctrl_fk|botSpine_ctrl_fk|topSpine_ctrl_fk|chest_ctrl_fk|Arm_Ctrl_grp_L|clavicle_rotatefix_grp_L_DONTFREEZE|clavicle_ctrl_fk_L" 
		"rotateZ" " -av"
		2 "|Ctrl_Main_Grp|MainCtrl|ctrl_grp|center_ctrl_fk|botSpine_ctrl_fk|topSpine_ctrl_fk|chest_ctrl_fk|Arm_Ctrl_grp_L|clavicle_rotatefix_grp_L_DONTFREEZE|clavicle_ctrl_fk_L" 
		"rotateY" " -av"
		...
		"rotate" " -type \"double3\" 0 0 34.100119588485953"
		2 "|Ctrl_Main_Grp|MainCtrl|ctrl_grp|center_ctrl_fk|botSpine_ctrl_fk|topSpine_ctrl_fk|chest_ctrl_fk|scarf_rotatefix_grp_a|scarf_ctrl_a|scarf_rotatefix_grp_b|scarf_ctrl_b|scarf_rotatefix_grp_c|scarf_ctrl_c|scarf_rotatefix_grp_d|scarf_ctrl_d" 
		"rotateZ" " -av"
		2 "|Ctrl_Main_Grp|MainCtrl|ctrl_grp|center_ctrl_fk|botSpine_ctrl_fk|topSpine_ctrl_fk|chest_ctrl_fk|scarf_rotatefix_grp_a|scarf_ctrl_a|scarf_rotatefix_grp_b|scarf_ctrl_b|scarf_rotatefix_grp_c|scarf_ctrl_c|scarf_rotatefix_grp_d|scarf_ctrl_d" 
		"rotationOrder" " -k 1"
		...
		"translate" " -type \"double3\" 4.1642563065338427 7.7940578771274716 0.1360553645626793"
...
createNode animCurveTL -n "hand_ctrl_ik_R_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 4.1642563065338427 20 4.2576933859079009
...
createNode animCurveTL -n "hand_ctrl_ik_R_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 7.7940578771274716 20 7.5022277150676668
...
createNode animCurveTL -n "hand_ctrl_ik_R_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0.1360553645626793 20 0.15481400663499695
...
createNode animCurveTU -n "hand_ctrl_ik_L_armTwist";
	...
	setAttr -s 7 ".ktv[0:6]"  1 0 20 -141.40000000000003 52 4.2999999999999652
		 65 0 79 -90.200000000000031 108 -90.200000000000031 117 -90.200000000000031;
	setAttr -s 7 ".kit[3:6]"  1 1 18 18;
	setAttr -s 7 ".kot[3:6]"  1 1 18 18;
	setAttr -s 7 ".kix[3:6]"  1 1 1 1;
	setAttr -s 7 ".kiy[3:6]"  0 0 0 0;
...
// End of PilotTestAnimation_002.0002.ma
