...
//Name: PilotTestAnimation_001.0017.ma
//Last modified: Thu, Mar 10, 2016 09:52:08 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 59.240187326091096 5.60596695145043 26.459607197781445 ;
	setAttr ".r" -type "double3" 1.4616472602786412 2204.9999999994538 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F98489E5-483E-8AB7-C65E-6AAE6420EB56";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 67.518965716624521;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 20.820103510604703 8.6098745591763048 5.8559319434702477 ;
...
createNode animCurveTA -n "scarf_ctrl_a_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  1 19.841011142442305 3 19.841011142442305
...
createNode animCurveTA -n "scarf_ctrl_a_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  1 4.5261553205498126 3 4.5261553205498126
		 ...
		 32 28.210353914069312 35 19.843621193933078 38 25.361303256184964 42 20.907230363764441
...
createNode animCurveTA -n "scarf_ctrl_a_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  1 -19.004208631693658 3 -14.260347222194302
		 5 -33.788967915477272 7 -22.195342449217584 9 -7.630726351602009 11 -2.448311370356183
		 13 -7.630726351602009 15 -7.630726351602009 17 5.234523531206289 19 26.132196123463817
...
createNode animCurveTA -n "scarf_ctrl_b_rotateY";
	...
	setAttr -s 21 ".ktv[0:20]"  1 0 3 0 5 0 7 0 9 0 11 0 13 0 15 0 17 0
		 ...
		 35 34.69300580524834 38 28.746565689341377 42 29.65141717155873 46 14.825716538908262
		 50 0 55 0;
createNode animCurveTA -n "scarf_ctrl_b_rotateZ";
	...
	setAttr -s 21 ".ktv[0:20]"  1 -11.177694777346236 3 -6.0297418279710309
		 ...
		 13 -22.324847959745359 15 -14.533391742424016 17 -17.637728805251786 19 10.554052932571381
...
createNode animCurveTA -n "scarf_ctrl_c_rotateY";
	...
	setAttr -s 21 ".ktv[0:20]"  1 0 3 0 5 0 7 0 9 0 11 0 13 0 15 0 17 0
		 ...
		 35 12.966501875329829 38 -3.5771202413903742 42 -18.999790543106183 46 -9.4999003676934315
		 50 0 55 0;
createNode animCurveTA -n "scarf_ctrl_c_rotateZ";
	...
	setAttr -s 21 ".ktv[0:20]"  1 -30.155974145591497 3 -19.066080344019646
		 5 -7.9761890212320523 7 -13.519623132891354 9 -19.063059227037304 11 -10.361343012930345
		 13 -19.063059227037304 15 -16.775387039246581 17 -11.609287631534102 19 -31.795084988214093
		 22 3.9643778688485871 24 5.2958501684471351 26 4.9308690519929339 29 4.7281704315645152
		 32 -12.608726001884042 35 -17.866071592053526 38 -1.6235613539131857 42 -10.9287575401687
...
createNode animCurveTA -n "scarf_ctrl_d_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  1 0 3 0 5 0 7 0 9 0 11 -15.248672741095431
		 13 0 15 0 17 0 19 0 22 0 24 3.2183149990162536 26 6.436629998032509 29 6.436629998032509
		 32 6.436629998032509 35 12.970353105666879 38 11.894124418508142 42 20.302714459631456
		 46 10.151362675427452 50 0 55 0;
createNode animCurveTA -n "scarf_ctrl_d_rotateZ";
	...
	setAttr -s 21 ".ktv[0:20]"  1 5.1220798217937284 3 9.3226111460445189
		 5 15.417984569887055 7 18.762589396276041 9 2.80683320096125 11 -10.03384830827588
		 13 20.280825497421816 15 38.184290468401791 17 56.087736231060312 19 16.917080789021327
...
createNode animCurveTA -n "scarf_ctrl_e_rotateY";
	...
	setAttr -s 21 ".ktv[0:20]"  1 0 3 0 5 0 7 0 9 0 11 0 13 0 15 0 17 0
		 ...
		 35 12.970353105666879 38 6.436629998032509 42 6.436629998032509 46 3.2183167254547498
		 50 0 55 0;
createNode animCurveTA -n "scarf_ctrl_e_rotateZ";
	rename -uid "F0FBADBD-40A3-019D-044F-46A1C0BFDE92";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  1 -34.021003839794467 3 -110.80150859351531
		 5 9.9776362376070296 7 -13.770270629258814 9 -7.630726351602009 11 -7.630726351602009
		 13 -7.630726351602009 15 -23.174058434009762 17 -50.825327723242339 19 -95.83846415760209
		 22 -104.4943529007713 24 34.739247064576865 26 4.9308690519929339 29 18.176966636678998
		 32 -25.577529050068826 35 -1.0664386096890994 38 -1.724123944336249 42 -7.5298915928696299
...
createNode animCurveTU -n "scarf_ctrl_a_visibility";
	...
	setAttr -s 22 ".ktv[0:21]"  1 1 3 1 5 1 7 1 9 1 11 1 13 1 15 1 17 1
		 19 1 22 1 24 1 26 1 29 1 32 1 35 1 38 1 42 1 46 1 50 1 52 1 55 1;
	setAttr -s 22 ".kit[20:21]"  9 18;
	setAttr -s 22 ".kot[20:21]"  5 18;
createNode animCurveTU -n "scarf_ctrl_a_rotationOrder";
	...
	setAttr -s 22 ".ktv[0:21]"  1 0 3 0 5 0 7 0 9 0 11 0 13 0 15 0 17 0
		 19 0 22 0 24 0 26 0 29 0 32 0 35 0 38 0 42 0 46 0 50 0 52 0 55 0;
	setAttr -s 22 ".kit[20:21]"  9 18;
	setAttr -s 22 ".kot[20:21]"  5 18;
...
// End of PilotTestAnimation_001.0017.ma
