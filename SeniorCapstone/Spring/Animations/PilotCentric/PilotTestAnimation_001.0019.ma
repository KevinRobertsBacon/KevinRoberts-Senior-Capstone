...
//Name: PilotTestAnimation_001.0019.ma
//Last modified: Fri, Mar 18, 2016 10:05:39 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 57.271944857423627 25.025919606558205 36.667891204098446 ;
	setAttr ".r" -type "double3" -19.538352739743715 2201.7999999993749 1.0666187384924322e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F98489E5-483E-8AB7-C65E-6AAE6420EB56";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 55.761325130410782;
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 36.987757203852915 2.0000000000000004 12.673872943608027 ;
	setAttr ".r" -type "double3" 5 44.069091956606123 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "63D0804E-465A-AA79-AF66-E383C3E8FB81";
	setAttr -s 15 ".lnk";
	setAttr -s 15 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "923EC315-4DDC-9EDD-F148-F88AB8A138FB";
createNode displayLayer -n "defaultLayer";
	rename -uid "61CCD973-4A3D-AA00-FECC-B1BA23CE5D6A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "11C531C1-452D-C920-9F2B-72828B02A352";
...
// End of PilotTestAnimation_001.0019.ma
