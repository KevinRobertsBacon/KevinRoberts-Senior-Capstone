...
//Name: CompositingScene_001.ma
//Last modified: Mon, Mar 28, 2016 09:29:10 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	rename -uid "BC72D7A6-4BCE-F581-357A-B19B09069C01";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 129.35696473891596 97.227754911329953 190.51171480576727 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "51F599ED-49ED-BC10-40AF-9C8589E729CD";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 207.07217905012487;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0.21003135714285714 61.154750066851221 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "8E4B597F-4201-10CA-02EE-A78297231BF0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "43E01ED8-489F-E8B0-99C3-F1B6C632FFB7";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "D1ECC39E-446E-91F5-31B4-528C232A9CEA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "108E4B11-43DC-C87C-4C90-30862E96513C";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "73E3CC16-436B-8B6A-24D2-E097F6040F6E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "AE460E66-41ED-659D-617C-0B8FB79DB777";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -n "Main_Camera";
	rename -uid "00973E75-41AF-E8EF-01E1-88B6113CD30C";
	setAttr ".t" -type "double3" 0 11.312027816669705 112.05758333422291 ;
createNode camera -n "Main_CameraShape" -p "Main_Camera";
	rename -uid "8E6903AA-47A4-C310-92FD-DEA3E767F405";
	setAttr -k off ".v";
	setAttr ".rnd" no;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8AEF40D4-415A-5BDA-05DA-928457B9A2A2";
	setAttr -s 14 ".lnk";
	setAttr -s 14 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "AB37A337-4EEC-F1AE-2443-D882ABCB6284";
createNode displayLayer -n "defaultLayer";
	rename -uid "EF633EF3-48CC-D0EF-A99E-2099A39D485C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "691B0EE7-4CB3-A97F-8A43-4487687C2D92";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "ADE294C8-4B00-0433-03AB-E49F8982D1C0";
	setAttr ".g" yes;
createNode reference -n "FighterModelMaya_RIGVERSION_0065RN";
	rename -uid "1871377B-4775-C704-5065-4B9689B866AE";
	setAttr -s 10 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"FighterModelMaya_RIGVERSION_0065RN" 18
		2 "|fighter_Main_Ctrl" "translate" " -type \"double3\" 0.43765958424924628 9.7009930881691364 -77.361726737489917"
		
		2 "|fighter_Main_Ctrl" "translateX" " -av"
		2 "|fighter_Main_Ctrl" "translateY" " -av"
		2 "|fighter_Main_Ctrl" "translateZ" " -av"
		2 "|fighter_Main_Ctrl" "rotate" " -type \"double3\" -181.28782242032133 4.7236173277235567 -145.49508668767425"
...
createNode animCurveTL -n "fighter_Main_Ctrl_translateX";
	rename -uid "A2011B03-47F5-DCF7-CF0F-1ABD259B2E04";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0.43765958424924628 31 0.43765958424924628
		 77 0.43765958424924628 89 0.43765958424924628 94 4.5827346706455856 116 0.43765958424924628;
createNode animCurveTL -n "fighter_Main_Ctrl_translateY";
	rename -uid "89CBAE24-46E8-F97F-73C2-0F99023ED55A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 9.7009930881691364 31 9.7009930881691364
		 77 9.7009930881691364 89 9.7009930881691364 94 9.9970035952000789 116 9.7009930881691364;
createNode animCurveTL -n "fighter_Main_Ctrl_translateZ";
	rename -uid "3B469012-4869-6569-A0C5-A093EE8DA4A1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -77.361726737489917 31 -77.361726737489917
		 77 -77.361726737489917 89 -77.361726737489917 94 -100.87304296497801 116 -77.361726737489917;
createNode animCurveTU -n "fighter_Main_Ctrl_visibility";
	rename -uid "F0F2BEAA-432D-05D2-30F2-4190818E8C72";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 31 1 77 1 89 1 94 1 116 1;
	setAttr -s 6 ".kot[0:5]"  5 5 5 5 5 5;
createNode animCurveTA -n "fighter_Main_Ctrl_rotateX";
	rename -uid "5CD88462-4845-2E91-EC67-719964C48EC9";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 65.453181395672615 31 18.089051836379824
		 77 -14.544601159697452 89 -38.16775815835642 94 -169.97648128844205 116 -181.28782242032133;
	setAttr -s 6 ".kit[0:5]"  18 18 1 1 1 18;
	setAttr -s 6 ".kot[0:5]"  18 18 1 1 1 18;
	setAttr -s 6 ".kix[2:5]"  0.99109089374542236 0.28878113627433777 
		0.78763502836227417 1;
	setAttr -s 6 ".kiy[2:5]"  -0.13318756222724915 -0.95739513635635376 
		-0.6161421537399292 0;
	setAttr -s 6 ".kox[2:5]"  0.99109089374542236 0.28878110647201538 
		0.78763514757156372 1;
	setAttr -s 6 ".koy[2:5]"  -0.13318759202957153 -0.95739513635635376 
		-0.61614203453063965 0;
createNode animCurveTA -n "fighter_Main_Ctrl_rotateY";
	rename -uid "52DCE8E7-4CA8-D4C6-926E-D3AD88B3F144";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 31 0 77 0 89 0 94 0 116 4.7236173277235567;
createNode animCurveTA -n "fighter_Main_Ctrl_rotateZ";
	rename -uid "1CA1B794-4775-B28B-D603-39ABA53C031D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -86.157868137566311 31 -43.166974035509675
		 77 -43.166974035509675 89 -85.915294800210376 94 -85.915294800210376 116 -145.49508668767425;
createNode animCurveTU -n "fighter_Main_Ctrl_scaleX";
	rename -uid "0C10B274-4204-1CBE-EF61-688F82B3622D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 31 1 77 1 89 1 94 1 116 1;
createNode animCurveTU -n "fighter_Main_Ctrl_scaleY";
	rename -uid "B74470B3-4D3A-2EF0-B0E1-C7811C641BE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 31 1 77 1 89 1 94 1 116 1;
createNode animCurveTU -n "fighter_Main_Ctrl_scaleZ";
	rename -uid "0B5AD9AE-4FE2-7D55-96FF-D186843EDA60";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 31 1 77 1 89 1 94 1 116 1;
createNode script -n "uiConfigurationScriptNode1";
	rename -uid "3A6D0532-4A22-5DCF-4AD6-0E8761CED8BD";
...
createNode script -n "sceneConfigurationScriptNode1";
	rename -uid "FDD44BBA-45CA-D64D-FDC4-0C89D35D0053";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode mentalrayItemsList -s -n "mentalrayItemsList";
	rename -uid "8FC59AAE-4701-472A-9E40-DFADFED37300";
createNode mentalrayGlobals -s -n "mentalrayGlobals";
	rename -uid "E6D28622-478C-22AF-4AA9-469680010D46";
createNode mentalrayOptions -s -n "miDefaultOptions";
	rename -uid "471431DE-4BB0-60D2-7842-6CB64A584FFA";
...
createNode mentalrayFramebuffer -s -n "miDefaultFramebuffer";
	rename -uid "ACA24BAC-43E4-0417-922D-83B585127214";
select -ne :time1;
	setAttr ".o" 120;
	setAttr ".unw" 120;
...
// End of CompositingScene_001.ma
