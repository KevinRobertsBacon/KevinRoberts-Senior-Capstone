...
//Name: EngineExhaust_001.0001.ma
//Last modified: Mon, Mar 28, 2016 01:59:55 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.0908081944290329 4.5681061458217558 6.090808194429016 ;
...
createNode nParticle -n "nParticleShape1" -p "nParticle1";
	...
	setAttr -s 5 ".rdc[0:4]"  0.22608696 1 1 1 0.16 1 0 0.63999999 
		1 0.13043478 0.88 1 0.39130434 0.66000003 1;
	setAttr ".rci" 2;
	...
	setAttr -s 2 ".opc[0:1]"  0 1 1 1 0.18000001 1;
	setAttr ".oci" 2;
	setAttr ".cl[0].clp" 0;
	setAttr ".cl[0].clc" -type "float3" 1 1 1 ;
	setAttr ".cl[0].cli" 1;
	setAttr ".inca[0].incap" 0;
	setAttr ".inca[0].incac" -type "float3" 0.56300002 0.56300002 0.56300002 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "435964FC-4347-445C-219A-E488F46FD5CD";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "11909FB4-44D5-D395-0CAF-3688890C316C";
createNode displayLayer -n "defaultLayer";
	rename -uid "C9321087-479E-ACB6-5CD3-88B8DD26E758";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "10494D48-4BE0-180E-8EE7-19B3D1FECC86";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "EA08D58C-4679-54B8-684D-F2B0841FD2E7";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -586.904738583263 -402.3809363917706 ;
	setAttr ".tgi[0].vh" -type "double2" 586.904738583263 401.19046024859961 ;
...
connectAttr "defaultRenderLayer.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "nParticlePointsSE.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "npPointsBlinn.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
...
// End of EngineExhaust_001.0001.ma
