...
//Last modified: Mon, Nov 16, 2015 11:31:48 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 77.67549482259767 602.79277864010328 1074.0567052287147 ;
	setAttr ".r" -type "double3" -32.738352729573073 -350.19999999999692 1.6138264602700639e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "AC002F66-4E74-DDDD-32EC-E9ADAD93C7E5";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1108.7193140379497;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "05267032-40A6-5A8C-9DD4-A884BB8BB714";
	setAttr -s 26 ".lnk";
	setAttr -s 26 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "5D92E17D-452A-F4BB-2DFC-C49ED03CE895";
createNode displayLayer -n "defaultLayer";
	rename -uid "5BABE51D-46C5-4CA0-0D3A-98B9D7699AC3";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B7C77070-407E-204D-50AA-0E9B3345BA50";
...
createNode reference -n "CockpitMaya_0001RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"CockpitMaya_0001RN" 2
		2 "|CockpitMaya_0001:Canopy_PlaneFBXASC046001" "visibility" " 0"
		2 "|CockpitMaya_0001:Canopy_PlaneFBXASC046001" "rotate" " -type \"double3\" 9.3346668283894176e-006 0 0";
...
createNode animCurveTL -n "root_Ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -770.87369440466057;
	setAttr ".kot[0]"  5;
...
createNode animCurveTL -n "Ik_foot_Ctrl_L_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 20.915769013405207;
	setAttr ".kot[0]"  5;
...
createNode animCurveTA -n "hip_Ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -22.665937860615191;
	setAttr ".kot[0]"  5;
...
connectAttr "root_Ctrl_scaleZ.o" "KR_PilotRig_Maya_0066RN.phl[5]";
connectAttr "root_Ctrl_scaleX.o" "KR_PilotRig_Maya_0066RN.phl[6]";
connectAttr "root_Ctrl_scaleY.o" "KR_PilotRig_Maya_0066RN.phl[7]";
connectAttr "root_Ctrl_translateY.o" "KR_PilotRig_Maya_0066RN.phl[8]";
...
connectAttr "root_Ctrl_visibility.o" "KR_PilotRig_Maya_0066RN.phl[11]";
...
connectAttr "hip_Ctrl_translateY.o" "KR_PilotRig_Maya_0066RN.phl[61]";
connectAttr "hip_Ctrl_translateZ.o" "KR_PilotRig_Maya_0066RN.phl[62]";
connectAttr "hip_Ctrl_translateX.o" "KR_PilotRig_Maya_0066RN.phl[63]";
