...
//Name: ShipTakeoffScene.0003.ma
//Last modified: Wed, Nov 25, 2015 11:30:40 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 880.16673959617219 295.68029499223383 278.57717308430671 ;
	setAttr ".r" -type "double3" -8.7383527296616084 432.99999999947329 2.7196156724400507e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "17C57E8D-4B59-D63E-99FB-F6A3DA4797D1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1072.8532573238263;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -121.49728303083015 8.0532141609100023 1.4747339646526711 ;
...
createNode fosterParent -n "NewFighterMaya_0003RNfosterParent1";
	rename -uid "B4D2270B-4390-8BBD-8248-389082811C41";
...
createNode reference -n "NewFighterMaya_0003RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" -99.122679939065804 295.26414764777422 89.954446275809531"
...
// End of ShipTakeoffScene.0003.ma
