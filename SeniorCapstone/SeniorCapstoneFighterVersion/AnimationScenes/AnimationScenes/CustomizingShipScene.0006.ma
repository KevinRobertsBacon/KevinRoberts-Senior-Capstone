...
//Last modified: Tue, Nov 17, 2015 10:48:27 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1340.3845735563414 623.28176412118796 453.00740258045823 ;
	setAttr ".r" -type "double3" -0.93835272989040364 443.79999999994311 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "EF71CF15-4C23-CE1F-AF5A-86B060722C47";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 335.11660759756148;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "57AB511C-4AFB-E454-D931-A7BAAF760617";
	setAttr -s 31 ".lnk";
	setAttr -s 31 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "398931B0-410E-A1CF-DE01-5B953B4B94D2";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4060024-43B0-FE5E-2529-7580C9523FB4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "85CEC19E-46D3-49BF-47AB-88A68407268E";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 293 -max 400 -ast 1 -aet 400 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "joint_Control_cheekOut_R2_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  360 2.842170943040325e-014;
	setAttr ".kot[0]"  5;
