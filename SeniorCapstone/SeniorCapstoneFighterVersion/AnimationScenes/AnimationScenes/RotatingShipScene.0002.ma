...
//Last modified: Wed, Dec 02, 2015 08:42:16 PM
//Codeset: 1252
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8EC407F4-46FD-FD51-C648-518DE73821C9";
	setAttr -s 12 ".lnk";
	setAttr -s 12 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "3955E9CE-482C-6928-64B5-F3A43D9D92DA";
createNode displayLayer -n "defaultLayer";
	rename -uid "F1BEE9EA-4001-A0BA-DF4A-3ABA8560E943";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A242B6C0-47CD-855A-530A-EDAD0D9F1496";
	setAttr ".crl" 1;
...
createNode reference -n "NewFighterMaya_0002RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|RotatingGroup|NewFighterMaya_0002:FORWARDGUNS2" "visibility" " -av 0"
		...
		2 "|RotatingGroup|NewFighterMaya_0002:AIRINTAKESBONUS1" "translate" " -type \"double3\" 0 0 0"
		...
		2 "|RotatingGroup|NewFighterMaya_0002:MISSILELAUNCHERS01" "visibility" " -av 0"
		...
		2 "|RotatingGroup|NewFighterMaya_0002:FORWARDGUNS1" "visibility" " -av 0"
		...
		" -av"
		2 "|RotatingGroup|NewFighterMaya_0002:EXTERNALFUELTANKS1" "visibility" " -av 0"
...
createNode rampShader -n "rampShader1";
	...
	setAttr ".cin" 2;
	setAttr ".smd" 1;
	setAttr ".shc" -type "float3" 0.032608531 0.032608531 0.032608531 ;
	setAttr ".it[0].itp" 0;
	...
	setAttr ".sc[0].scc" -type "float3" 0.028999999 0.028999999 0.028999999 ;
	setAttr ".sc[0].sci" 1;
	...
	setAttr ".env[0].envc" -type "float3" 0.0099999998 0.0099999998 0.0099999998 ;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "887B19CE-4C09-CFC3-F10B-6DB156C5D17C";
...
connectAttr "NewFighterMaya_0002RN.phl[4]" "defaultRenderLayer.oajs[6].opg";
connectAttr "NewFighterMaya_0002RN.phl[5]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[19]" "defaultRenderLayer.oajs[5].opg";
connectAttr "NewFighterMaya_0002RN.phl[20]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[34]" "defaultRenderLayer.oajs[4].opg";
connectAttr "NewFighterMaya_0002RN.phl[35]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[49]" "defaultRenderLayer.oajs[3].opg";
connectAttr "NewFighterMaya_0002RN.phl[50]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[64]" "defaultRenderLayer.oajs[2].opg";
connectAttr "NewFighterMaya_0002RN.phl[65]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[79]" "defaultRenderLayer.oajs[1].opg";
connectAttr "NewFighterMaya_0002RN.phl[80]" "rampShader1SG.dsm" -na;
...
connectAttr "NewFighterMaya_0002RN.phl[84]" "defaultRenderLayer.oajs[0].opg";
connectAttr "NewFighterMaya_0002RN.phl[85]" "rampShader1SG.dsm" -na;
