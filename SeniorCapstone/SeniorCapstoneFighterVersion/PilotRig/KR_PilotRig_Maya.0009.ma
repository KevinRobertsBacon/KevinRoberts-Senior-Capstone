...
//Name: KR_PilotRig_Maya.0009.ma
//Last modified: Tue, Oct 13, 2015 07:44:21 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.67486741441808595 0.97209218914092899 1.15229897745562 ;
	setAttr ".r" -type "double3" -19.538352730712923 -331.79999999982022 -9.0223029139863029e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.2858532583558309;
	setAttr ".ow" 0.1;
...
createNode joint -n "ik_jnt_thigh_L2" -p "bind_jnt_hips";
	...
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".t" -type "double3" 0.046444851954240647 -0.074142531648118168 -0.023662545438162784 ;
	setAttr ".r" -type "double3" -1.4021412073278786e-014 5.2134896013573325e-016 -2.5502206504619784e-016 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "ik_jnt_thigh_R2" -p "bind_jnt_hips";
	...
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".t" -type "double3" -0.046444899999999997 -0.074142553128608166 -0.0236625 ;
	setAttr ".r" -type "double3" 1.4021412020370818e-014 -5.2135009817632385e-016 2.5502264745605958e-016 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "ik_jnt_knee_R" -p "ik_jnt_thigh_R2";
	...
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".t" -type "double3" -0.25801445216793778 9.4802012062800139e-009 -9.380303309214355e-008 ;
	setAttr ".r" -type "double3" 5.9352819059153411e-019 8.3951963412138456e-013 1.7106688593645026e-012 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode ikHandle -n "ikHandle_foot_L";
	...
	setAttr ".pv" -type "double3" 0.87828986424914512 -0.086639835277060276 1.7947424476231628 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle_foot_R";
	rename -uid "F59D4BFF-4073-448D-9787-E384FE466E2A";
	setAttr ".t" -type "double3" -0.038486699999999971 0.04339399999999994 -0.044462800000000011 ;
	setAttr ".pv" -type "double3" -0.87827644744761402 -0.086640075543821068 1.7947490017182228 ;
	setAttr ".roc" yes;
...
createNode ikHandle -n "ikHandle_ball_R";
	...
	setAttr ".t" -type "double3" -0.038486700000000033 0.0081169500000001851 0.060517900000000048 ;
	setAttr ".r" -type "double3" -89.999999999998352 71.425948073334879 90.000000000000284 ;
	setAttr ".roc" yes;
...
createNode ikHandle -n "ikHandle_toe_R";
	...
	setAttr ".t" -type "double3" -0.038486700000000047 0.0064441000000002814 0.10651700000000006 ;
	setAttr ".r" -type "double3" -89.999998792567297 87.917248341617764 90.000000000013145 ;
	setAttr ".roc" yes;
createNode fosterParent -n "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "995BF70B-48FD-7136-F568-05B1074CB1EB";
...
createNode fosterParent -n "fosterParent1" -p "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "06D0593D-4289-791A-D434-909DB7261330";
...
// End of KR_PilotRig_Maya.0009.ma
