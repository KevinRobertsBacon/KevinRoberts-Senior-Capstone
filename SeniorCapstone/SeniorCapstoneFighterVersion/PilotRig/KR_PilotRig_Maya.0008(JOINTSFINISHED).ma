...
//Name: KR_PilotRig_Maya.0008(JOINTSFINISHED).ma
//Last modified: Tue, Oct 13, 2015 08:49:49 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.024477221852772998 0.84437427883962202 1.189338259614066 ;
	setAttr ".r" -type "double3" -15.338352730649468 -356.59999999978169 -9.9567589887174807e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.1767401749331807;
	setAttr ".ow" 0.1;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.25834117880629043 1.001 -0.0047091493111699294 ;
...
createNode joint -n "bind_jnt_hips" -p "bind_jnt_root";
	...
	setAttr ".radi" 0.5;
createNode joint -n "bind_jnt_thumbA_R";
	rename -uid "FD149650-45CE-BF83-3A7D-5B828B21E3C1";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" -0.41066800000000003 0.893163 -0.013715799999999993 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" -89.999999999999631 73.709968856302268 4.6683295085947201 ;
...
createNode joint -n "bind_jnt_thumbD_R" -p "bind_jnt_thumbC_R";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.53192370747432172;
createNode joint -n "bind_jnt_indexA_R";
	rename -uid "AE1DB8CA-4E68-808B-4388-11A6386EC52A";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" -0.42716000000000004 0.89451900000000006 -0.0078704899999999921 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 179.99999999996484 -1.8089404750823751e-014 -1.5632623027640597e-014 ;
...
createNode joint -n "bind_jnt_indexE_R" -p "bind_jnt_indexD_R";
	...
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_middleA_R";
	rename -uid "BF14C4DB-4B55-28B5-D693-B0B467D9F5FC";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" -0.42716000000000004 0.8979020000000002 -0.019918299999999983 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_middleE_R" -p "bind_jnt_middleD_R";
	...
	setAttr ".jo" -type "double3" 6.1566493183999546e-006 -9.6499812180506919e-022 1.2602499755577901e-021 ;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_ringA_R";
	rename -uid "1F92E89E-4EF9-F893-B0C6-3496D9594EC2";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" -0.42716000000000004 0.89738200000000012 -0.032700899999999984 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_ringE_R" -p "bind_jnt_ringD_R";
	...
	setAttr ".jo" -type "double3" 6.1566493183999546e-006 -9.6499812180506919e-022 1.2602499755577901e-021 ;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_pinkyA_R";
	rename -uid "68D34F33-4570-971A-AF1E-E1A3EDC3A981";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" -0.42716000000000004 0.89574500000000012 -0.04605419999999999 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_pinkyE_R" -p "bind_jnt_pinkyD_R";
	...
	setAttr ".jo" -type "double3" 6.1566493183999546e-006 -9.6499812180506919e-022 1.2602499755577901e-021 ;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_pinkyA_L";
	rename -uid "ACDF1A39-4BE6-18E5-DA32-23830BEA4DE6";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" 0.42715963743621616 0.89574547012203665 -0.046054197834846093 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" -7.7955434067801192e-012 2.5245652784116664e-014 8.2789335246506174e-015 ;
	setAttr ".bps" -type "matrix" 1.0000000000000002 -3.7875361163121943e-017 -6.2450045135165055e-017 0
		 1.9081958235744878e-016 1 -1.3831985687037807e-013 0 -1.0755285551056204e-016 1.3834048177203217e-013 1 0
		 42.7159637436216 89.574547012203652 -4.6054197834845967 1;
	setAttr ".radi" 0.56705375879702213;
...
createNode joint -n "bind_jnt_pinkyE_L" -p "bind_jnt_pinkyD_L";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_ringA_L";
	rename -uid "DB9CB361-427A-644C-C0B3-8EA89B85EC91";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" 0.42715963743621621 0.8973816066521072 -0.032700933890593198 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_ringE_L" -p "bind_jnt_ringD_L";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_middleA_L";
	rename -uid "6568C49C-4A58-E4ED-52D9-D0ABFC865CD4";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" 0.42715963743621632 0.89790246569182586 -0.019918262531466013 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_middleE_L" -p "bind_jnt_middleD_L";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_indexA_L";
	rename -uid "9F833078-4F2E-1674-6498-9788F0AE229A";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" 0.42715963743621621 0.89451851191343201 -0.0078704921434327082 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_indexE_L" -p "bind_jnt_indexD_L";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.54545777757373914;
createNode joint -n "bind_jnt_thumbA_L";
	rename -uid "98FD210B-4850-500D-31ED-ACB7638B154E";
	addAttr -ci true -sn "liw" -ln "lockInfluenceWeights" -min 0 -max 1 -at "bool";
	setAttr ".oc" 1;
	setAttr ".t" -type "double3" 0.41066750644203581 0.8931632538024199 -0.013715804394534672 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 90.000000000000398 -73.70996885630224 -4.6683295085947645 ;
	setAttr ".bps" -type "matrix" 0.27956915838921942 -0.022829198233776094 0.95985411046968305 0
		 -0.95666981982511812 0.078120222870410483 0.28049970876001568 0 -0.081387600488770265 -0.99668252642788946 3.4629417389187012e-016 0
		 41.066750644203559 89.316325380241977 -1.3715804394534548 1;
	setAttr ".radi" 0.5641167134028483;
...
createNode joint -n "bind_jnt_thumbD_L" -p "bind_jnt_thumbC_L";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.53192370747432172;
createNode joint -n "bind_jnt_shoulder_L";
	rename -uid "BFF0F25F-4676-6139-0FC7-E5A692967CAF";
	setAttr ".t" -type "double3" 0.097915477529831707 0.90015654078578511 -0.03188823170952268 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 6.4164232118229452e-015 2.3283943378397081 3.1573979361736762e-013 ;
...
createNode joint -n "bind_jnt_wrist" -p "bind_jnt_elbow_L";
	...
	setAttr ".radi" 1.2532931585682823;
createNode joint -n "bind_jnt_thigh_L";
	rename -uid "F83EF8FA-488B-3C35-BF64-F190467E2F01";
	setAttr ".t" -type "double3" 0.042693907348141533 0.56579482458080033 -0.023635130659478837 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode joint -n "bind_jnt_toe_L" -p "bind_jnt_ball_L";
	...
	setAttr ".radi" 0.6403388965804826;
createNode joint -n "bind_jnt_shoulder_R";
	rename -uid "AFED2C5F-4D62-E347-41EE-2083A5602CC6";
	setAttr ".t" -type "double3" -0.097915500000000016 0.900157 -0.031888199999999998 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 179.99999914622634 -2.3283943378397085 0 ;
	setAttr ".radi" 1.2203392341501824;
createNode joint -n "bind_jnt_elbow_R" -p "bind_jnt_shoulder_R";
	...
	setAttr ".radi" 1.2532931585682823;
createNode joint -n "bind_jnt_wrist" -p "bind_jnt_elbow_R";
	...
	setAttr ".radi" 1.2532931585682823;
createNode joint -n "bind_jnt_thigh_R";
	rename -uid "0A20C586-46C5-1F28-B648-51AB581D342D";
	setAttr ".t" -type "double3" -0.0426939 0.565795 -0.023635099999999999 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
createNode fosterParent -n "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "DD566B6B-41F4-F87F-5DC5-86A01224885E";
...
createNode fosterParent -n "fosterParent1" -p "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "FCCE4795-4A9E-F6F3-43B8-E48644B77925";
...
connectAttr "bind_jnt_elbow_L.s" "|bind_jnt_shoulder_L|bind_jnt_elbow_L|bind_jnt_wrist.is"
		;
...
connectAttr "bind_jnt_elbow_R.s" "|bind_jnt_shoulder_R|bind_jnt_elbow_R|bind_jnt_wrist.is"
		;
...
// End of KR_PilotRig_Maya.0008(JOINTSFINISHED).ma
