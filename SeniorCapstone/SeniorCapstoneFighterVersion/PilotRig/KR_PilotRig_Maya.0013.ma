...
//Name: KR_PilotRig_Maya.0013.ma
//Last modified: Tue, Oct 13, 2015 09:13:01 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.0184448332055402 1.0776585914127439 0.98688734399196065 ;
	setAttr ".r" -type "double3" -20.738352730653016 -315.39999999965863 1.1167269439755942e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.4887242461589789;
	setAttr ".ow" 0.1;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 66.929611695101045 -2.1850348207081467 ;
...
createNode joint -n "ik_jnt_shoulder_R2" -p "bind_jnt_clavicle_R";
	...
	setAttr ".t" -type "double3" -0.056195408801562222 0.0017680530232971137 -0.0022130693088354158 ;
	setAttr ".r" -type "double3" 1.4021832383778214e-014 -8.4956693136746024e-024 5.7013517854256756e-016 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -8.537736778008399e-007 -24.834507489592813 -21.218105775346405 ;
...
createNode joint -n "ik_jnt_thigh_L2" -p "bind_jnt_hips";
	...
	setAttr ".t" -type "double3" 0.042693907348141533 -0.063292728547807833 -0.023635130659478837 ;
	setAttr ".r" -type "double3" -1.4023564606335186e-014 5.2580723894429897e-016 -1.6651179441427729e-030 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 89.999999999999972 0 -89.999999999999972 ;
	setAttr ".radi" 1.840735196555765;
...
createNode ikHandle -n "ikHandle_hand_L";
	...
	setAttr ".pv" -type "double3" -3.0531133177191805e-016 2.2557933197814563e-013 -1.9999999999999998 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle_hand_R";
	...
	setAttr ".pv" -type "double3" -5.5511151231257827e-017 2.9777694123198737e-008 -1.9999999999999998 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle_foot_L";
	...
	setAttr ".pv" -type "double3" 7.4983469541470266e-015 -0.074936443363000677 1.9985956393067865 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle_foot_R";
	...
	setAttr ".pv" -type "double3" -9.0003878926085976e-016 -0.07493642253046047 1.9985956400878935 ;
	setAttr ".roc" yes;
...
createNode fosterParent -n "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "51114DA6-4EE5-31FF-F7FF-0D93DBDBE2DA";
...
createNode fosterParent -n "fosterParent1" -p "KR_PilotModel_Maya_0010RNfosterParent1";
	rename -uid "6EB27B2D-424A-C3BF-AE24-6EBA7AE0AC58";
...
// End of KR_PilotRig_Maya.0013.ma
